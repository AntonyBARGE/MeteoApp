...
//     return weatherCard(size.height,
//       child: Column(
//         children: [
//           cityHeadline(cityTitleStyle),
//           Expanded(
//             child: Stack(
//               children: [
//                 Padding(
...
//   void changeSelectedDate(DateTime newDate, int newDayController){
//     setState(() {
//       dayController = newDate;
//       selectedDay = newDate;
//     });
//   }
...
//         Expanded(
//           child: Padding(
//             padding: EdgeInsets.only(bottom: 25.0, left: screenWidth/5, right: screenWidth/5),
